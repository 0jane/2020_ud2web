...
<!-- User Login Modal HTML -->
<div id="userLoginModal" class="modal fade" aria-hidden="true" data-backdrop="static">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				<form action="" method="post">
					...
					<div class="form-group">
						<button type="button" class="btn btn-primary btn-block btn-lg" id="login_button">登入系統</button>						
					</div>
				</form>				
